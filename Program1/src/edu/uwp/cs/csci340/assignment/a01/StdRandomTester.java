 ...
 *  @author Kevin Wayne
 */
public final class StdRandomTester {
...
//            StdOut.println();
//        }
        int array1[] = new int[1000]; //instantiates an array of type int with a size of 1,000
        double array2[] = new double[10000]; //instantiates an array of type double with a size of 10,000
        for(int i = 0; i < 1000; i++) { //iterates through array1
            array1[i] = uniform(1000000); //adds a random int between 1-1,000,000 to array1 in position i
        }
        for(int i = 0; i < 10000; i++) { //iterates through array2
            array2[i] = gaussian(); //adds a random double to array2 in position i
        }
        for (int i: array1) //iterates through each int in array1
        {
            System.out.println(i); //prints int at position i in array1
        }
        for (double i: array2) //iterates through each double in array2
        {
            System.out.println(i); //prints double at position i in array2
        }
    }
